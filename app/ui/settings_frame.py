...
class UserProfileTab(QWidget):
    ...
    def _build_profile_card(self):
        ...
        # Username badge — larger, darker
        self.username_badge = QLabel("@--")
        self.username_badge.setFont(QFont("Segoe UI", 20, QFont.Weight.Bold))
        self.username_badge.setStyleSheet("color:#0B2A4A; border:none;")
        # Role badge — larger subtext
        self.role_badge = QLabel("--")
        self.role_badge.setFont(QFont("Segoe UI", 16, QFont.Weight.Medium))
        ...
        self.last_login_lbl.setFont(QFont("Segoe UI", 15))
        self.last_login_lbl.setStyleSheet("color:#4A6785; border:none;")
        ...
        form.addRow(self._field_label("Họ và tên:"), self.le_fullname)
        ...
        form.addRow(self._field_label("Số điện thoại *:"), self.le_phone)

        self.le_username = QLineEdit()
        self.le_username.setReadOnly(True)
        self.le_username.setStyleSheet(
            self._input_style() + " background:#f7f7f7; color:#999;")
        form.addRow(self._field_label("Tên đăng nhập:"), self.le_username)
    ...
    def _build_change_password_card(self):
        ...
        form.addRow(self._field_label("Mật khẩu cũ:"), self.le_old_pw)
        ...
        form.addRow(self._field_label("Mật khẩu mới:"), self.le_new_pw)
        ...
        form.addRow(self._field_label("Xác nhận:"), self.le_confirm_pw)
    ...
    def _show_pw_msg(self, msg: str, kind: str):
        ...
        self.pw_msg.setStyleSheet(
            ...
            f"border-radius:8px; padding:8px 12px; font-size:16px; }}")
    ...
    def _panel_frame(title: str) -> QFrame:
        ...
        lbl = QLabel(title)
        lbl.setFont(QFont("Segoe UI", 19, QFont.Weight.Bold))
    ...
    def _field_label(text: str) -> QLabel:
        """Larger, darker form field label."""
        lbl = QLabel(text)
    ...
    def _btn_primary():
        return ("QPushButton { background:#E6F1FB; color:#0B2A4A; "
                ...
                "padding:7px 16px; font-size:16px; font-weight:500; } "
                "QPushButton:hover { background:#B5D4F4; }")
